export const IMAGE_MODELS = [
  {
    ...
    note: "Best reference editing",
    available: true,
  },
  {
    id: "google/gemini-3.1-flash-image",
    label: "Nano Banana 2",
    note: "Fast reference editing",
    available: true,
  },
  {
    id: "openai/gpt-image-2",
    label: "GPT Image 2",
    note: "High-detail image editing",
    available: true,
  },
...
export const VIDEO_MODELS = [
  {
    ...
    label: "Veo 3.1 Lite",
    note: "Fast image-to-video",
    available: true,
  },
  {
    id: "google/veo-3.1-fast",
    label: "Veo 3.1 Fast",
    note: "Higher motion quality",
    available: true,
  },
...
export const BRAIN_MODELS = [
  {
    ...
    note: "Fast cinematic direction",
    available: true,
  },
  {
    id: "google/gemini-3.1-pro-preview",
    label: "Gemini Pro Brain",
    note: "Deep visual reasoning",
    available: true,
  },
  {
    id: "openai/gpt-5.5",
    label: "Synthetic Council",
    note: "Premium story intelligence",
    available: true,
  },
