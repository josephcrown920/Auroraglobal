...
const ARTIST_TOOL_ROWS: ToolRow[] = [
  ...
  { idx: "05", name: "AURORA SOUL", badge: "NEW", description: "Identity-guided shoot direction", price: "10 CR", to: "/likeness", previewImg: "/nav-previews/avatar.jpg" },
  ...
  { idx: "07", name: "DIRECTOR'S ROOM", badge: "SUITE", description: "Cinematic visual production suite", price: "12 CR", to: "/director-room", previewImg: "/nav-previews/scene-builder.jpg" },
