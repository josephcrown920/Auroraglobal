...
const COMMANDS: Cmd[] = [
  {
    cmd: "aurora login",
    desc: "Start the device-code sign-in flow and link the CLI to your account.",
  },
  { cmd: "aurora whoami", desc: "Show the signed-in account, current plan and remaining Aura." },
  {
    cmd: 'aurora generate --prompt "neon street" --out shot.png',
    desc: "Render a still image with Nano Banana Pro and save it to disk.",
    cost: "1 Aura",
  },
  {
  ...
  },
  {
    ...
    desc: "Align an audio track to mouth shapes with Sync 1.9.",
    cost: "6 Aura",
  },
