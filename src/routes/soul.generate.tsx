...
export const Route = createFileRoute("/soul/generate")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: "Generate Images — Aurora Soul" },
      { name: "description", content: "Generate identity-locked images of your trained character." },
      { property: "og:url", content: `${CANONICAL_ORIGIN}/soul/generate` },
      featureVisibilityRobotsMeta(loaderData),
    ],
    links: [{ rel: "canonical", href: `${CANONICAL_ORIGIN}/soul/generate` }],
  }),
});
