  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className="phone-edge-right fixed bottom-[calc(5rem_+_env(safe-area-inset-bottom))] z-50 size-14 rounded-full flex items-center justify-center text-white shadow-2xl shadow-violet-900/50 bg-gradient-to-br from-violet-600 to-purple-500 hover:scale-105 transition-transform"
      >
      ...
      {open && (
        <div className="phone-edge-right fixed bottom-24 z-50 w-[min(92vw,380px)] h-[min(72vh,560px)] rounded-3xl border border-white/10 bg-[#0c0a1c]/95 backdrop-blur-2xl shadow-2xl shadow-violet-950/60 flex flex-col overflow-hidden animate-fade-in">
          <header className="px-4 py-3 border-b border-white/10 flex items-center gap-3">
            <span className="size-9 rounded-xl flex items-center justify-center bg-gradient-to-br from-violet-600 to-purple-500">
            ...
            {messages.map((m, i) => (
              <div
                ...
                className={`max-w-[85%] rounded-2xl px-3.5 py-2.5 text-sm whitespace-pre-wrap leading-relaxed ${
                  m.role === "user"
                    ? "ml-auto bg-gradient-to-br from-violet-600 to-purple-500 text-white"
          ...
          <form onSubmit={send} className="border-t border-white/10 p-3 flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Send"
              className="size-10 rounded-full flex items-center justify-center text-white bg-gradient-to-br from-violet-600 to-purple-500 disabled:opacity-50"
            >
