...
const SERVICES: {
  ...
  { icon: Film, title: "Video Generation", desc: "Cinematic 5–10s performance clips. Seedance 5.9, Kling, Gemini Omni and Grok Imagine in one canvas.", to: "/studio", accent: "from-indigo-500/30 to-violet-500/10", preview: "video", videoUrl: demo2.url },
  { icon: ImageIcon, title: "Image Generation", desc: "Cover art and press shots from a selfie. Powered by Gemini Omni and Grok Imagine.", to: "/studio", accent: "from-violet-500/30 to-fuchsia-500/10", preview: "photo", photoUrl: "/gallery/violet-haze.webp", photoAlt: "AI generated cover art – Violet Haze" },
  ...
  { icon: Activity, title: "Perform Anywhere", desc: "Film yourself on your phone. Drop the clip + your AI photo — Aurora transfers your real motion into the scene. Seedance 5.9 · Kling · Gemini Omni · Grok Imagine.", to: "/motion", accent: "from-cyan-500/30 to-blue-500/10", preview: "photo", photoUrl: "/gallery/josh-neon-tech.png", photoAlt: "Josh neon tech performance" },
