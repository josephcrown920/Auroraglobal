...
video_agent = VideoAgent(primary_client=seedream, fallback_client=seedream_fb, reasoning_client=None)
...
tts_agent = TTSAgent(primary_client=kokoro, fallback_client=None, reasoning_client=None)
...
motion_agent = MotionAgent(primary_client=champ, fallback_client=animatediff, reasoning_client=None)
...
lipsync_agent = LipsyncAgent(primary_client=latentsync, fallback_client=None, reasoning_client=None)
