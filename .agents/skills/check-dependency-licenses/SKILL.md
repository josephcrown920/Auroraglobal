...
---
**Activation:** On-demand — fires when adding a dependency or before release. Agent-actionable: it inspects dependency licenses itself; license-vs-policy calls are escalated to you for review.
