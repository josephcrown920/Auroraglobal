...
description: Use when building anything that collects, stores, or transmits user data — sign-up, profiles, payments, uploads, analytics, logging — or when the user mentions PII, GDPR, CCPA, HIPAA, PCI, or privacy.
---
