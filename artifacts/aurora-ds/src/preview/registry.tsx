...
export const DESIGN_SYSTEM = {
  ...
  description:
    'Violet-on-dark visual language for Aurora Studio: deep navy backgrounds, glass-morphism surfaces, liquid button feel, and Plus Jakarta Sans typography.',
} as const;
...
const LogoPage = lazyPage(() =>
  import('./demos/logo').then(({ LogoPage }) => LogoPage),
);
    ...
    entries: [
      {
        id: 'brand-logo',
        name: 'Logo',
        description: 'Aurora wordmark and icon usage.',
        Page: LogoPage,
      },
    ],
  },
