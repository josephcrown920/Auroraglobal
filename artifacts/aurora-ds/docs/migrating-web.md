# Migrating web UI to Aurora Design System

Read `artifacts/aurora-ds/docs/AGENTS.md` and
`artifacts/aurora-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/aurora-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/aurora-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/aurora-ds/hooks/use-toast`
