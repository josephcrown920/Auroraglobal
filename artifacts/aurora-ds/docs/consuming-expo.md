# Consuming Aurora Design System in Expo apps

Read `artifacts/aurora-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/aurora-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/aurora-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/aurora-ds/lib/native-theme";
import { useColors } from "@workspace/aurora-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/aurora-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/aurora-ds/components/native/badge";
import { Button } from "@workspace/aurora-ds/components/native/button";
import { Card } from "@workspace/aurora-ds/components/native/card";
```
...
Import and render
`@workspace/aurora-ds/components/native/button`, then run Expo
